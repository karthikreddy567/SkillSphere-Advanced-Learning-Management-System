...
function StudentViewCoursesPage(){
    ...
    useEffect(()=>{
        const builtQueryStringForFilters = createSearchParamsHelper(filters)
        setSearchParams(new URLSearchParams(builtQueryStringForFilters))
    },[filters]);
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button
                        variant="outline"
                        size="sm"
                        className="flex item-center gap-2 p-5"
                    >
